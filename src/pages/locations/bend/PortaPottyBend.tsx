...
const faqs = [
  ...
  },
  {
    ...
    a: 'OSHA standard: one unit per 10 workers on a single-shift site, serviced at minimum once every seven days. Two-shift operations add 50 percent capacity and require twice-weekly service. Tell us your crew size and shift schedule on the form and we will confirm the right unit count.',
  },
  {
          ...
          <div className="use-cases">
            <div className="use-case">
              ...
              <p style={{ marginTop: '12px' }}>
                One unit per 10 workers. Serviced at minimum once every seven days. Delivered on a hard arrival window so your crew is not standing around waiting. By inspection day, the box is checked, the site is compliant, and your crew has not left the property once to find a restroom.
              </p>
            ...
            <div className="why-item">
              ...
              <blockquote style={testimonialStyle.blockquote}>
                <p style={testimonialStyle.text}>
                  [Testimonial placeholder — confirmed delivery time / crew didn't wait / hard window was honored]
                </p>
