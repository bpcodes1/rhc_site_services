  ...
  return (
    <main id="main">
      <Helmet>
        ...
        <meta name="description" content="Confirmed clean before delivery, no hidden fees. Steel storage containers in 10ft, 20ft, and 40ft for construction and renovation across Oregon and Washington." />
