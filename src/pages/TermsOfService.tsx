...
const schema = graph([
  ...
  webPage({
    ...
    description:
      'The terms that apply to using the RHC Site Services website, including how quotes work and the limits of the specifications and permit guidance published here.',
